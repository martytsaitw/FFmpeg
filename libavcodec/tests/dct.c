...
static const struct algo idct_tab[] = {
    ...
    { "SIMPLE-C",    ff_simple_idct_int16_8bit_xij,     FF_IDCT_PERM_NONE },
    { "SIMPLE-C10",  ff_simple_idct_int16_10bit_xij,    FF_IDCT_PERM_NONE },
    { "SIMPLE-C12",  ff_simple_idct_int16_12bit_xij,    FF_IDCT_PERM_NONE, 0, 1 },
...
int main(int argc, char **argv)
{
    ...
    if (test_248_dct) {
        idct248_error("SIMPLE-C", ff_simple_idct248_put_xij, speed);
    } else {
