...
{
    testxmmclobbers(avcodec_open2_xij, avctx, codec, options);
}
...
wrap(avcodec_decode_audio4_xij(AVCodecContext *avctx,
                           ...
                           AVPacket *avpkt))
{
    testxmmclobbers(avcodec_decode_audio4_xij, avctx, frame,
                    got_frame_ptr, avpkt);
}
...
wrap(avcodec_decode_video2_xij(AVCodecContext *avctx,
                           ...
                           AVPacket *avpkt))
{
    testxmmclobbers(avcodec_decode_video2_xij, avctx, picture,
...
wrap(avcodec_decode_subtitle2_xij(AVCodecContext *avctx,
                              ...
                              AVPacket *avpkt))
{
    testxmmclobbers(avcodec_decode_subtitle2_xij, avctx, sub,
                    got_sub_ptr, avpkt);
}
...
{
    testxmmclobbers(avcodec_send_packet_xij, avctx, avpkt);
}
...
{
    testxmmclobbers(avcodec_receive_frame_xij, avctx, frame);
}
